...
const SOCIALS = [
  {
    name: 'GitHub',
    href: 'https://github.com/Pavi-web',
    icon: (
  ...
  {
    name: 'LinkedIn',
    href: 'https://linkedin.com/in/pavithra-madhusoodhanan-3b1572251',
    icon: (
      <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
...
export default function FinalConvergence() {
  ...
  const handleSubmit = (e) => {
    ...
    window.location.href =
      `mailto:pavithramadhusoodhanan04@gmail.com?subject=Hello from ${encodeURIComponent(form.name)}&body=${encodeURIComponent(form.message)}`;
    setSent(true);
    ...
    >
      ...
      >
        ...
        <span style={{ fontFamily: 'var(--font-display)', fontSize: '1rem', fontWeight: 800, color: '#fff' }}>
          PAVITHR<span style={{ color: 'var(--brand-cyan)' }}>A</span>
        </span>
        ...
        <span style={{
          ...
          © {new Date().getFullYear()} Pavithra · Designed &amp; Built with ♥ using React &amp; Framer Motion
        </span>
