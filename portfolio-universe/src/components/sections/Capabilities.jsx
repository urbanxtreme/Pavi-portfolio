...
const BENTO_CARDS = [
  {
    ...
    body: 'Building interactive and high-performance applications with React.js, Next.js, Redux, and Tailwind CSS. Crafting structured design systems for responsive, accessible web interfaces.',
    icon: '⬘',
  },
  {
    spanX: 1, spanY: 1,
    ...
    body: 'Leveraging Python, Pandas, and NumPy for complex data preprocessing. Designing machine learning pipelines and classification models with Scikit-Learn.',
    icon: '◈',
  },
  {
    spanX: 1, spanY: 1,
    ...
    label: '03 / WebGL',
    title: '3D Orbitals & Space Apps',
    body: 'Rendering interactive Three.js and custom viewport simulations, as demonstrated in the NASA Space Apps Challenge and scientific visualizations.',
    icon: '⬡',
  },
  {
    spanX: 2, spanY: 1,
    ...
    body: 'Spearheading campus developer groups, hackathons, and technical workshops as TinkerHub Campus Lead, IEEE WIE Vice Chair, and FOSS Women in Tech Lead.',
    icon: '◎',
  },
];
